...
```text
trackastra/
├── benchmark3.ipynb       # Notebook principal (Pipeline completo)
├── src/                   # Código fuente y utilidades
├── watershed_masks/       # Salida: Máscaras generadas por Watershed
├── cellpose_masks/        # Salida: Máscaras generadas por Cellpose
├── tracked_results/       # Salida: Resultados de tracking (Formato CTC)
